...
PRINT 'Password verification test: ' + cast(@isValid as varchar(max));
...
DECLARE @decryptedBinaryValue VARBINARY(MAX);

-- Note: For binary data, we need to convert to string first for encryption
